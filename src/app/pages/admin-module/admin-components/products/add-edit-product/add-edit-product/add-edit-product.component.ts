...
categores = [
  {name: 'Structure Decks', id: 1},
  {name: 'Starter Decks', id: 2},
  {name: 'Booster packs', id: 3},
  {name: 'Accesories', id: 4}];
  ...
  ngOnInit() {
    ...
    this.addProductForm.patchValue({tournamentStoreLaunchDate: this.product.tournamentStoreLaunchDate });
    this.addProductForm.patchValue({launchDate: this.product.launchDate });
    this.addProductForm.patchValue({konamiTournamentLegalDate: this.product.konamiTournamentLegalDate });
    ...
    this.addProductForm.patchValue({isActive: this.product.isActive });
    this.addProductForm.patchValue({shortDescription: this.product.shortDescription });
    //this.addProductForm.patchValue({photo1: this.product.photo1 });
    //this.addProductForm.patchValue({photo2: this.product.photo2 });
    this.addProductForm.patchValue({inStock: this.product.inStock });
    this.addProductForm.patchValue({onSalePercent: this.product.onSalePercent });
