...
export class ProductService {
  ...
  generateProductFromForm(form: FormGroup): Product {
    ...
    product.konamiTournamentLegalDate = formData.konamiTournamentLegalDate ? formData.konamiTournamentLegalDate : null;
    product.launchDate = formData.launchDate ? formData.launchDate : null;
    ...
    product.tournamentStoreLaunchDate = formData.tournamentStoreLaunchDate ? formData.tournamentStoreLaunchDate : null;;
