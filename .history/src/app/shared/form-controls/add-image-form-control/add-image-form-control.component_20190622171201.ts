import { Component, OnInit, AfterViewInit, ViewChild, Renderer2, HostListener, ElementRef, EventEmitter } from '@angular/core';
...
export class AddImageFormControlComponent implements OnInit, ControlValueAccessor {
  ...
  @Output() onEZClientFillData = new EventEmitter<string>();
