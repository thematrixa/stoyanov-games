...
export class ProductDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.galleryImages = [
      {
        small: "assets/Images/structure-deck-mock.jpg",
        medium: "assets/Images/structure-deck-mock.jpg",
        big: "assets/Images/structure-deck-mock.jpg"
      },
      {
  ...
  hasUserCommentd(){
    let loggedUser = this.userService.getLoggedUser();
    this.productService.hasUserCommented(loggedUser.username, this.product.id).subscribe(res => {
