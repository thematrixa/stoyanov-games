...
export class AddEditProductComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.addProductForm.patchValue({ forphoto1: this.product.photo1File.name });
    this.addProductForm.patchValue({ forphoto2: this.product.photo2File.name });
    this.addProductForm.patchValue({ price: this.product.price });
    document.getElementById("forphoto1").innerHTML = this.product.photo1File.name;
    document.getElementById("forphoto2").innerHTML = this.product.photo1File.name;
  ...
  handleFileInput(event: any) {
    ...
    document.getElementById("for" + event.target.id).innerHTML = event.target.files.item(0).name;
  }
}
