...
export class AddEditProductComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.addProductForm.patchValue({ forphoto1: this.product.photo1File });
    this.addProductForm.patchValue({ forphoto2: this.product.photo2File });
    ...
    document.getElementById("forphoto2").innerHTML = this.product.photo2File.name;
