  ...
  getBase64(event) {
    ...
    reader.onload = function () {
      ...
      if (event.target.id === "photo1") {
        addProductForm.patchValue({ photo1: reader.result });
      } else if (event.target.id === "photo2") {
        addProductForm.patchValue({ photo2: reader.result });
      } else if (event.target.id === "photo3") {
        addProductForm.patchValue({ photo3: reader.result });
      } else if (event.target.id === "photo4") {
        addProductForm.patchValue({ photo4: reader.result });
      } else if (event.target.id === "photo5") {
        addProductForm.patchValue({ photo5: reader.result });
      }
