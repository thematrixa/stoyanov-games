...
export class AdminModuleComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sideMenuList.push({name: 'Изображения', routerLink: 'images', dropdown: this.productsDropdown});
    this.sideMenuList.push({name: 'Купони', routerLink: 'coupons', dropdown: []});
    this.sideMenuList.push({name: 'Промоции', routerLink: 'on-sale', dropdown: []});
    this.sideMenuList.push({name: 'История', routerLink: 'logs', dropdown: this.productsDropdown});
